...
import { Plus, Users, BookOpen, GraduationCap, Code } from 'lucide-react';
...
export default function Home() {
  ...
  const handleCreateClassroom = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!name || !subject || !teacherName || !teacherEmail) {
  ...
  const handleJoinClassroom = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!classCode || !studentName || !studentEmail) {
              ...
              <Dialog open={joinOpen} onOpenChange={setJoinOpen}>
                ...
                <DialogContent className="bg-slate-900/95 border-slate-700">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Enter your class code and details to join a classroom
                    </DialogDescription>
                  </DialogHeader>
                  <form onSubmit={handleJoinClassroom} className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="studentEmail" className="text-white">Your Email</Label>
                      <Input
                        id="studentEmail"
                        name="studentEmail"
                        type="email"
              ...
              <Dialog open={createOpen} onOpenChange={setCreateOpen}>
                ...
                <DialogContent className="bg-slate-900/95 border-slate-700">
                  ...
                  <form onSubmit={handleCreateClassroom} className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="teacherName" className="text-white">Your Name</Label>
                      <Input
                        id="teacherName"
                        name="teacherName"
                        placeholder="Enter your full name"
                    ...
                    <div>
                      <Label htmlFor="teacherEmail" className="text-white">Your Email</Label>
                      <Input
                        id="teacherEmail"
                        name="teacherEmail"
                        type="email"
      ...
      <main className="container mx-auto px-4 py-8">
        {classrooms.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Welcome to ClassRoom</h2>
